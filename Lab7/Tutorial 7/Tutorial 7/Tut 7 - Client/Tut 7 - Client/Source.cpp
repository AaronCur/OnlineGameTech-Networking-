...
int main()
{
	Client myClient("149.153.106.164",1111); //Create client to localhost ("127.0.0.1") on port 1111
	...
	while (true)
	{
		...
		if (!myClient.SendString("Cur: " +userinput)) //Send string: userinput, If string fails to send... (Connection issue)
