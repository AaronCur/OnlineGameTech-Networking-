...
bool StateParser::parseState(const string stateFile, string stateID, vector<GameObject *> *pObjects, std::vector<std::string> *pTextureIDs)
{
    ...
    {
        cerr << "Could not load file: " << stateFile << ", error: " << xmlDoc.ErrorDesc() << "\n";
        return false;
    }
